...
class _HomePageState extends State<HomePage> {
                    ...
                    RichText(
                      text: TextSpan(
                        children: <TextSpan>[
                          ...
                          TextSpan(
                            text: DataProviderModel.cityName.toString(),
                    ...
                    RichText(
                      text: TextSpan(
                        children: <TextSpan>[
                          ...
                          TextSpan(
                            text: DataProviderModel.stationName.toString(),
                            style: TextStyle(color: Colors.grey, fontSize: 20),
                          ),
                        ],
                      ),
                    ...
                    RichText(
                      text: TextSpan(
                        children: <TextSpan>[
                          ...
                          TextSpan(
                            text: DataProviderModel.gateName.toString(),
                            style: TextStyle(color: Colors.grey, fontSize: 20),
                          ),
                        ],
                      ),
  ...
  checkQR() async {
    ...
    try {
      ...
      if (data["Metro"] == DataProviderModel.cityName.toString() && DataProviderModel.gateName.toString() == "Entry"
          ? data["Source"].toString() == DataProviderModel.stationName
          : data["Destination"].toString() == DataProviderModel.stationName) {
        ...
        if (snapshot.exists) {
          ...
          status = "Pass";
          setState(() {});
          if (DataProviderModel.gateName == "Exit") {
            String? tempNum;
            await fire
                .collection("qr-ticket-data")
                .doc(data["Id"].toString())
